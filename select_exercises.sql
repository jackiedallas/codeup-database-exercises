...
SELECT release_date AS 'Sgt. Pepper''s Lonely Hearts Club was released in', release_date
FROM albums
...
SELECT name AS 'Albums released in the 90s', release_date
FROM albums
WHERE release_date BETWEEN 1989 AND 1991;

# Albums with less than 20 million in sales
SELECT name as 'Albums with less than 20 million copies sold', sales
FROM albums
WHERE sales < 20;
